...
<div class="tip">💡 When analyzing any passage, always start by identifying the rhetorical situation. Ask: Who is speaking? To whom? Why? About what? In what context? This framework unlocks every other analysis question.</div>
      `,
      questions: [
        { q: 'The "exigence" in a rhetorical situation refers to:', options: ['The writer\'s credentials', 'The issue or situation that prompts the writing', 'The audience\'s response', 'The historical period'], answer: 1 },
        { q: 'A writer "demonstrates understanding of the audience" by:', options: ['Using complex vocabulary', 'Appealing to the audience\'s beliefs, values, or needs', 'Writing in first person', 'Including a bibliography'], answer: 1 },
        { q: 'The "context" of a rhetorical situation includes:', options: ['Only the text itself', 'The broader social, historical, cultural environment', 'The writer\'s biography', 'The page layout'], answer: 1 },
        { q: 'The "purpose" answers which question?', options: ['Who is writing?', 'When was it written?', 'What does the writer want the audience to do, think, or feel?', 'How long is the text?'], answer: 2 },
...
<div class="tip">💡 On the exam, pay attention to HOW a writer qualifies claims. Absolute statements ("always," "never") are weaker arguments than qualified ones. When you see a counterargument acknowledged, that's the writer strengthening their position by showing they've considered other perspectives.</div>
      `,
      questions: [
        { q: 'A "qualified claim" is one that:', options: ['Makes an absolute statement', 'Uses modifiers, counterarguments, or alternative perspectives to limit or nuance the claim', 'Has no evidence', 'Is written by an expert'], answer: 1 },
        { q: 'The overarching thesis of an argument is:', options: ['A minor supporting detail', 'The central claim the entire text supports', 'The conclusion paragraph', 'A counterargument'], answer: 1 },
        { q: 'Which is an example of qualifying a claim?', options: ['"All schools must adopt this policy"', '"While some districts face budget constraints, the evidence suggests this approach benefits most students"', '"This is the only solution"', '"Everyone agrees"'], answer: 1 },
        { q: 'Expert testimony is effective evidence because:', options: ['It\'s always true', 'It comes from a credible authority in the field', 'It\'s emotional', 'It uses statistics'], answer: 1 },
...
<div class="tip">💡 When the exam asks about "line of reasoning," trace the path: What's the first claim? How does it lead to the second? Does each piece of evidence connect to the next paragraph? Does it all support the thesis? If you can follow the logic, the reasoning is sound.</div>
      `,
      questions: [
        { q: 'A "line of reasoning" is:', options: ['A single sentence', 'The logical sequence of claims and evidence building toward the thesis', 'The conclusion only', 'A list of sources'], answer: 1 },
        { q: 'The "cause and effect" method of development:', options: ['Tells a story', 'Explains why something happens and its results', 'Defines a term', 'Sorts into categories'], answer: 1 },
        { q: '"Unity" in writing means:', options: ['Using the same word repeatedly', 'Every paragraph and sentence connects to the thesis', 'All paragraphs are the same length', 'The essay has one paragraph'], answer: 1 },
        { q: '"Coherence" is achieved through:', options: ['Long sentences', 'Transitions, repetition of key terms, parallel structure', 'Complex vocabulary', 'Avoiding pronouns'], answer: 1 },
        { q: 'A writer who addresses counterarguments first, then presents their position, is using:', options: ['Narration', 'Classification', 'Refutation structure', 'Description'], answer: 2 },
...
<div class="tip">💡 On the exam, "how does the writer's style contribute to the argument?" means: What specific word choices, sentence structures, and figurative language create the tone? And how does that tone serve the purpose? Always connect style choices BACK to purpose and audience.</div>
      `,
      questions: [
        { q: 'Connotation refers to:', options: ['The dictionary definition', 'The emotional or associative meaning of a word', 'The word\'s origin', 'Correct spelling'], answer: 1 },
        { q: 'A periodic sentence:', options: ['States the main idea first', 'Builds to the main idea at the END', 'Has no main clause', 'Is always short'], answer: 1 },
        { q: 'Anaphora is:', options: ['A type of metaphor', 'Repeating a word/phrase at the start of successive clauses', 'An exaggeration', 'A comparison using "like"'], answer: 1 },
        { q: 'Subordination in sentence structure:', options: ['Makes all ideas equal', 'Makes one idea dependent on another, showing which is more important', 'Eliminates dependent clauses', 'Uses only simple sentences'], answer: 1 },
        { q: 'Tone is best described as:', options: ['The reader\'s emotional response', 'The writer\'s attitude toward the subject or audience', 'The topic of the text', 'The length of sentences'], answer: 1 },
        { q: 'A writer uses a dash (—) to:', options: ['End a sentence', 'Create emphasis, interruption, or aside', 'Indicate a question', 'Show possession'], answer: 1 },
...
<div class="tip">💡 For passage-based questions on Huck Finn: always consider (1) what Huck understands vs. what the reader understands (dramatic irony), (2) how the passage connects to the civilization vs. freedom theme, and (3) what Twain is satirizing about society through Huck's observations.</div>
      `,
      questions: [
        { q: '"All right, then, I\'ll go to hell" represents:', options: ['Huck giving up on Jim', 'Huck choosing personal conscience over society\'s rules — the climax of his moral journey', 'Huck deciding to be religious', 'Huck agreeing with society'], answer: 1 },
        { q: 'The river in Huck Finn symbolizes:', options: ['Danger and death', 'Freedom, moral clarity, and escape from society', 'Slavery and oppression', 'Civilization and order'], answer: 1 },
        { q: 'Twain\'s use of Huck as a naive narrator creates:', options: ['Confusion', 'Dramatic irony — the reader understands more than Huck does', 'A reliable perspective', 'Historical accuracy'], answer: 1 },
        { q: 'Tom Sawyer\'s elaborate rescue plan at the end critiques:', options: ['Jim\'s desire for freedom', 'Romantic, impractical thinking that trivializes real suffering', 'Huck\'s moral growth', 'The river\'s symbolism'], answer: 1 },
        { q: 'The Grangerford-Shepherdson feud satirizes:', options: ['Northern industry', 'Southern "honor" culture and religious hypocrisy', 'Western expansion', 'Educational systems'], answer: 1 },
        { q: 'Pap Finn represents:', options: ['Moral authority', 'The worst of white society — racist, violent, yet legally privileged', 'Fatherly wisdom', 'The American Dream'], answer: 1 },
        { q: 'When Huck apologizes to Jim (Ch. 15), this is significant because:', options: ['It\'s good manners', 'A white boy humbling himself to a Black man was a radical moral act for the time', 'Jim demanded it', 'Tom told him to'], answer: 1 },
        { q: 'Huck\'s "deformed conscience" refers to:', options: ['A physical disability', 'His conscience shaped by a racist society that tells him helping Jim is sinful', 'His lack of education', 'His relationship with Pap'], answer: 1 },
        { q: 'The King and Duke\'s con games expose:', options: ['The intelligence of townspeople', 'How easily "civilized" people are fooled by greed', 'Jim\'s naivety', 'Huck\'s dishonesty'], answer: 1 },
...
<div class="tip">💡 On exam questions about Omelas, connect everything back to the central moral dilemma: knowledge + acceptance = complicity. Le Guin's style choices (narrator addressing reader, juxtaposition of beauty and horror, ambiguous ending) all serve one purpose: making the reader feel the weight of the moral choice.</div>
      `,
      questions: [
        { q: 'Omelas\'s happiness depends on:', options: ['Good government', 'The suffering of a single child kept in misery', 'Natural resources', 'Religious belief'], answer: 1 },
        { q: 'The central moral question of the story is:', options: ['How to build a city', 'Is it justified to sacrifice one person\'s suffering for the happiness of many?', 'Why children suffer', 'How to escape a city'], answer: 1 },
        { q: '"The ones who walk away" represent:', options: ['People who don\'t like festivals', 'Those who choose individual moral conscience over society\'s comfort', 'Criminals fleeing justice', 'The child\'s parents'], answer: 1 },
        { q: 'Le Guin uses direct address ("Do you believe?") to:', options: ['Confuse the reader', 'Implicate the reader in the moral dilemma', 'Establish historical context', 'Introduce a character'], answer: 1 },
        { q: 'Omelas functions as an allegory for:', options: ['A specific historical city', 'Any society that benefits from the suffering of others', 'A religious parable only', 'A science fiction future'], answer: 1 },
        { q: 'The juxtaposition of Omelas\'s beauty and the child\'s suffering creates:', options: ['Humor', 'A sharp contrast that forces the reader to confront the moral cost of happiness', 'Confusion about the setting', 'A happy ending'], answer: 1 },
        { q: 'The ambiguity of the ending (we don\'t know where they go) suggests:', options: ['The author forgot to finish', 'There may be no perfect alternative — only the moral choice to refuse complicity', 'They return to Omelas', 'A sequel is coming'], answer: 1 },
...
<div class="tip">💡 The synthesis essay is NOT a research paper — it's an argument that USES sources. Your voice and analysis should dominate. Sources are evidence for YOUR claims, not the other way around. If you're spending more time summarizing sources than arguing your position, you're doing it wrong.</div>
      ...
      questions: [
        ...
        { q: 'The most important element of a synthesis essay is:', options: ['The hook', 'A clear, arguable thesis', 'Long quotes', 'A summary of all sources'], answer: 1 },
        { q: '"Quote dumping" refers to:', options: ['Using too few quotes', 'Dropping quotes without analysis or explanation', 'Paraphrasing', 'Citing sources correctly'], answer: 1 },
        { q: 'Addressing a counterargument in your essay:', options: ['Weakens your argument', 'Strengthens your argument by showing you\'ve considered other perspectives', 'Is never required', 'Means you agree with the opposition'], answer: 1 },
        { q: 'The CEAC formula stands for:', options: ['Cite, Explain, Argue, Conclude', 'Claim, Evidence, Analysis, Connection', 'Context, Evidence, Argument, Claim', 'Compare, Evaluate, Analyze, Critique'], answer: 1 },
        { q: 'In a synthesis essay, your voice should:', options: ['Disappear behind the sources', 'Dominate — sources are evidence for YOUR claims', 'Only appear in the introduction', 'Match the tone of Source A'], answer: 1 },
...
<div class="tip">💡 For the vocabulary MCQs (Q1–20): focus on Units 7–12 definitions and how words are used in context (sentence completions). For passage-based MCQs: knowing these rhetorical terms helps you identify what the writer is doing and why.</div>
      `,
      questions: [
        { q: 'Ethos appeals to:', options: ['Emotion', 'Logic and data', 'Credibility and character', 'Fear'], answer: 2 },
        { q: 'Antithesis creates emphasis through:', options: ['Repetition', 'Contrasting ideas in balanced phrases', 'Emotional language', 'Statistics'], answer: 1 },
        { q: 'A "straw man" fallacy involves:', options: ['Using personal attacks', 'Misrepresenting an opponent\'s argument to attack it more easily', 'Presenting only two options', 'Changing the subject'], answer: 1 },
        { q: 'Asyndeton (omitting conjunctions) creates a feeling of:', options: ['Slowness and reflection', 'Speed, urgency, and emphasis', 'Confusion', 'Formality'], answer: 1 },
        { q: 'Chiasmus is a reversed grammatical structure. Which is an example?', options: ['"To be or not to be"', '"Ask not what your country can do for you — ask what you can do for your country"', '"I have a dream"', '"We the People"'], answer: 1 },
        { q: 'A "red herring" fallacy:', options: ['Uses emotional appeals', 'Introduces an irrelevant topic to divert attention from the real issue', 'Attacks the person', 'Uses faulty statistics'], answer: 1 },
...
<div class="tip">💡 The exam is worth 100 points total: 65 MCQ + 35 essay. The essay alone is worth more than a third of your grade — don't rush it. A strong essay can compensate for missed MCQs, but not the other way around.</div>
      `,
      questions: [
        { q: 'Vocabulary questions (Q1–20) are worth:', options: ['1 point each', '0.5 points each', '2 points each', '0.25 points each'], answer: 1 },
        { q: 'The synthesis essay is worth what percentage of the total exam?', options: ['10%', '25%', '35%', '50%'], answer: 2 },
        { q: 'When approaching a skills-based passage, you should first:', options: ['Write an essay about it', 'Read the questions to know what to look for', 'Skip to the next section', 'Count the paragraphs'], answer: 1 },
        { q: '"The author includes X in order to..." questions ask about:', options: ['Grammar', 'The rhetorical PURPOSE of a writing choice', 'Historical context', 'The author\'s biography'], answer: 1 },
