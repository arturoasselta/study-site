...
<div class="tip">💡 Denaturation = protein loses shape (and function) due to heat or pH change. Shape = function in biology. A denatured enzyme cannot catalyze its reaction.</div>
      `,
      questions: [
        { q: 'Which property of water allows lakes to support life in winter?', options: ['High specific heat', 'Ice being less dense than liquid water — floats, insulating below', 'Cohesion', 'Universal solvent property'], answer: 1 },
        { q: 'The monomers of proteins are:', options: ['Nucleotides', 'Monosaccharides', 'Amino acids connected by peptide bonds', 'Fatty acids'], answer: 2 },
        { q: 'An enzyme lowers:', options: ['The free energy change (ΔG) of the reaction', 'The activation energy needed to start the reaction', 'The temperature of the reaction', 'The concentration of products'], answer: 1 },
        { q: 'Competitive inhibition works by:', options: ['Changing the shape of the active site', 'Binding the allosteric site', 'Mimicking the substrate and blocking the active site', 'Denaturing the enzyme'], answer: 2 },
        { q: 'Cellulose and starch are both made of glucose, but differ because:', options: ['Starch uses α-glucose (digestible); cellulose uses β-glucose (indigestible)', 'Cellulose has more energy than starch', 'Starch is found in animals; cellulose is in bacteria', 'They use different monomers entirely'], answer: 0 },
...
<div class="tip">💡 Remember: Mitochondria and chloroplasts have 70S ribosomes (like bacteria) — supporting endosymbiotic theory. All other eukaryotic ribosomes are 80S.</div>
      `,
      questions: [
        { q: 'Which two organelles support the endosymbiotic theory?', options: ['Nucleus and Golgi apparatus', 'Mitochondria and chloroplasts (own DNA, 70S ribosomes, double membranes)', 'Rough ER and smooth ER', 'Lysosomes and vacuoles'], answer: 1 },
        { q: 'The correct order in the endomembrane secretory pathway is:', options: ['Golgi → Rough ER → Plasma membrane', 'Rough ER → Golgi → Secretory vesicles → Plasma membrane', 'Nucleus → Ribosome → Smooth ER → Golgi', 'Lysosome → Golgi → Rough ER'], answer: 1 },
        ...
        { q: 'Lysosomes function by:', options: ['Synthesizing lipids for the cell membrane', 'Containing hydrolytic enzymes for intracellular digestion', 'Producing ATP for the cell', 'Packaging proteins for export'], answer: 1 },
        { q: 'The central vacuole in plant cells is important for:', options: ['Photosynthesis', 'Maintaining turgor pressure and storage', 'Protein synthesis', 'ATP production'], answer: 1 },
...
<div class="tip">💡 The ETC is where most ATP is made (~28 of ~32 total). NADH yields ~2.5 ATP; FADH₂ yields ~1.5 ATP. O₂ is essential as the final electron acceptor — without it, the ETC shuts down.</div>
      `,
      questions: [
        { q: 'The Calvin Cycle (light-independent reactions) takes place in the:', options: ['Thylakoid membranes', 'Stroma of the chloroplast', 'Inner mitochondrial membrane', 'Cytoplasm'], answer: 1 },
        ...
        { q: 'The purpose of fermentation is to:', options: ['Produce more ATP than aerobic respiration', 'Regenerate NAD⁺ so glycolysis can continue in the absence of O₂', 'Break down CO₂ into glucose', 'Transfer electrons to O₂'], answer: 1 },
        { q: 'C4 plants reduce photorespiration by:', options: ['Only doing photosynthesis at night', 'Fixing CO₂ in mesophyll cells and concentrating it near RuBisCO in bundle sheath', 'Completely eliminating the Calvin cycle', 'Using FADH₂ instead of NADPH in the light reactions'], answer: 1 },
...
<div class="tip">💡 Cancer = uncontrolled cell division. Loss of tumor suppressor genes (p53 = "guardian of the genome") + activation of oncogenes = cancerous growth. Apoptosis is the cell's built-in self-destruct mechanism.</div>
      ...
      questions: [
        ...
        { q: 'DNA replication occurs during which phase of the cell cycle?', options: ['G1', 'G2', 'S phase', 'Mitosis'], answer: 2 },
        { q: 'During Anaphase of mitosis:', options: ['Chromosomes align at the metaphase plate', 'The nuclear envelope reforms', 'Sister chromatids are pulled to opposite poles', 'Chromatin condenses into chromosomes'], answer: 2 },
        { q: 'Tumor suppressor genes like p53:', options: ['Accelerate the cell cycle', 'Inhibit the cell cycle and promote apoptosis when DNA is damaged', 'Create new blood vessels for tumors', 'Activate oncogenes'], answer: 1 },
        { q: 'Cytokinesis differs between animal and plant cells because:', options: ['Only plant cells have cytokinesis', 'Animals use a cleavage furrow; plants form a cell plate (rigid wall)', 'Plant cells divide by binary fission', 'Animal cells do not complete mitosis'], answer: 1 },
...
<div class="tip">💡 Crossing over in Prophase I = genetic recombination. It's why siblings have different gene combinations even from the same parents. The more cross-overs, the more genetic diversity.</div>
      ...
      questions: [
        ...
        { q: 'A monohybrid cross between two heterozygotes (Aa × Aa) produces what phenotype ratio?', options: ['1:2:1', '9:3:3:1', '3:1 (3 dominant : 1 recessive)', '1:1'], answer: 2 },
        { q: 'Codominance differs from incomplete dominance in that:', options: ['Codominance produces a blended phenotype; incomplete dominance expresses both alleles fully', 'Incomplete dominance produces a blended phenotype; codominance expresses both alleles fully', 'They are the same phenomenon', 'Codominance only occurs with sex-linked genes'], answer: 1 },
        { q: 'Nondisjunction during meiosis results in:', options: ['Normal gametes with correct chromosome number', 'Gametes with too many or too few chromosomes', 'Complete failure of cell division', 'Only monosomy, never trisomy'], answer: 1 },
        { q: 'Pleiotropy refers to:', options: ['Multiple genes controlling one trait', 'One gene affecting multiple phenotypic traits', 'Incomplete expression of a dominant allele', 'Genes on the same chromosome'], answer: 1 },
...
<div class="tip">💡 Degeneracy (redundancy) of the genetic code means multiple codons can code for the same amino acid — that's why silent mutations exist. The code has 64 codons but only 20 amino acids.</div>
      `,
      questions: [
        { q: 'During translation, the A site of the ribosome is where:', options: ['The growing polypeptide chain is held', 'A new tRNA carrying an amino acid enters', 'Completed tRNAs exit', 'mRNA processing occurs'], answer: 1 },
        { q: 'A frameshift mutation is caused by:', options: ['A single nucleotide substitution', 'Insertion or deletion of nucleotides (not in multiples of 3)', 'A stop codon being created', 'Silent mutation in the 3rd codon position'], answer: 1 },
        { q: 'The lac operon is considered "inducible" because:', options: ['It is always expressed at high levels', 'Lactose removes the repressor, turning transcription ON', 'Tryptophan acts as a corepressor to turn it off', 'It only works in eukaryotes'], answer: 1 },
        { q: 'Histone acetylation promotes gene expression by:', options: ['Adding methyl groups to silence genes', 'Loosening chromatin structure, making DNA accessible for transcription', 'Destroying mRNA after translation', 'Blocking RNA polymerase binding'], answer: 1 },
        { q: 'The start codon for translation is:', options: ['UAA', 'UGA', 'UAG', 'AUG — codes for methionine'], answer: 3 },
...
<div class="tip">💡 Hardy-Weinberg is your "null hypothesis" for evolution. If q² = 0.04, then q = 0.2 and p = 0.8. Plug back in to find all genotype frequencies.</div>
      `,
      questions: [
        { q: 'Stabilizing selection results in:', options: ['A shift toward one extreme phenotype', 'Increased variation with two phenotypic extremes favored', 'Reduced variation with the intermediate phenotype favored', 'No change in phenotype distribution'], answer: 2 },
        { q: 'In a population where q² = 0.09, what is the frequency of the dominant allele (p)?', options: ['0.09', '0.3', '0.7', '0.91'], answer: 2 },
        { q: 'The bottleneck effect results in:', options: ['Increased genetic diversity after a disaster', 'Reduced genetic diversity due to a sudden population crash', 'New alleles being introduced from another population', 'Stronger natural selection pressure'], answer: 1 },
        { q: 'Allopatric speciation requires:', options: ['Polyploidy in plants', 'Geographic isolation that leads to reproductive isolation', 'Sympatric populations sharing the same habitat', 'Sexual selection only'], answer: 1 },
        { q: 'A mule (horse × donkey hybrid) is sterile — this is an example of:', options: ['Prezygotic barrier — behavioral isolation', 'Postzygotic barrier — hybrid sterility', 'Prezygotic barrier — gametic isolation', 'Founder effect'], answer: 1 },
...
<div class="tip">💡 The 10% energy rule means 90% of energy is lost as heat at each trophic level. A 1,000 calorie plant feeds a 100-calorie herbivore, which feeds a 10-calorie carnivore. That's why food chains are short (3–5 levels max).</div>
      `,
      questions: [
        { q: 'Logistic population growth produces an S-shaped curve because:', options: ['Populations always grow at a constant rate', 'Resources become limiting as the population approaches carrying capacity (K)', 'The population experiences exponential growth indefinitely', 'Only r-selected species grow logistically'], answer: 1 },
        { q: 'In mutualism, the outcome for both species is:', options: ['+ / −', '+ / 0', '+ / +', '− / −'], answer: 2 },
        { q: 'The 10% rule in energy flow means:', options: ['Plants capture 10% of sunlight', '10% of energy transfers to the next trophic level; 90% is lost as heat', 'Decomposers receive 10% of all energy', 'Primary consumers convert 10% of food to body heat'], answer: 1 },
